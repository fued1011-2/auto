...
/**
 * Exception-Klasse für eine bereits existierende FIN-Nummer.
 */
export class FinExistsException extends HttpException {
    readonly fin: string | undefined;

    constructor(fin: string | undefined) {
        super(
            `Die FIN ${fin} existiert bereits.`,
